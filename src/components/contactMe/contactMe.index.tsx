        ...
        <div className='mt-52'>
            ...
            <div className='flex justify-center'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-5 justify-items-center max-w-7xl'>
                    <div className='min-w-[225px] flex flex-col justify-center items-center bg-[#333333] p-5 rounded-md transition ease-in-out delay-150 hover:translate-x-0 hover:scale-110 duration-300 hover:drop-shadow-2xl'>
